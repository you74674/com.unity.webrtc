...
namespace WebRTC
{
    ...
    bool NvVideoCapturer::InitializeEncoder(IGraphicsDevice* device, bool preferSoftwareEncoder)
    {
        try
        {
            EncoderFactory::GetInstance().Init(width, height, device, preferSoftwareEncoder);
        }
